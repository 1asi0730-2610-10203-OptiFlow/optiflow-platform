...
public record ApplyPromotionalDiscountResource(
    [Required] [StringLength(50, ErrorMessage = "DiscountCode must be at most 50 characters")] [SwaggerParameter(Description = "Discount code to apply")] string DiscountCode,
