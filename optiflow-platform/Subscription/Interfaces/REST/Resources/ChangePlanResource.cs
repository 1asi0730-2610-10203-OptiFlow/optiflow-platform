...
public record ChangePlanResource(
    ...
    [Required] [StringLength(50, ErrorMessage = "NewTier must be at most 50 characters")] [SwaggerParameter(Description = "New tier")] string NewTier,
    ...
    [Required] [StringLength(50, ErrorMessage = "PaymentMethod must be at most 50 characters")] [SwaggerParameter(Description = "Payment method for the new plan")] string PaymentMethod);
